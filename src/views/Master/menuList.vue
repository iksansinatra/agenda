      ...
      <q-card-section class="bg-cyan-9 text-white">
        <div class="row">
          <div class="col-12 col-md-9">
            ...
            <div class="text-h6">Data Master Menu</div>
            </div>
          </div>
          <div class="col-12 col-md-3">
            <div class="row" style="margin: 0 5px 2px">
              ...
              <q-btn glossy class="bg-light-blue-7" @click="mdl_add = true" dense flat icon="add" style="width:15%">
                ...
                <q-card class="mdl-md">
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6 frame_cari">
                            ...
                            <q-select outlined dense v-model="form.type" :options="$store.state.type" option-label="uraian" option-value="id" />
                    ...
                    <q-card-actions class="bg-grey-4 mdl-footer" align="right">
                        <q-btn color="light-blue-7" @click="addData()" label="Simpan" />
...
export default {
  ...
  methods: {
    ...
    // ====================================== PAGINATE ====================================
        Notify : function(message, color, icon){
          this.$q.notify({
            message: message,
            color: color,
            icon: icon,
